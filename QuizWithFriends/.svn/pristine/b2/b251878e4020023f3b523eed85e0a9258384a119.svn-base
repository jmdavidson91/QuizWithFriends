...
public class MyDB {
	...
	private static final String MYSQL_USERNAME = "ccs108ajaustin";
	private static final String MYSQL_PASSWORD = "laiphoog";
	private static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	private static final String MYSQL_DATABASE_NAME = "c_cs108_ajaustin";
